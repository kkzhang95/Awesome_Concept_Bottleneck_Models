...
| NeurIPS 2025 | [Debugging Concept Bottleneck Models through Removal and Retraining](https://arxiv.org/pdf/2509.21385) |  [Code](https://github.com/ericenouen/cbdebug)|
...
| CVPR 2025 | [CoE: Chain-of-Explanation via Automatic Visual Concept Circuit Description and Polysemanticity Quantification](https://openaccess.thecvf.com/content/CVPR2025/papers/Yu_CoE_Chain-of-Explanation_via_Automatic_Visual_Concept_Circuit_Description_and_Polysemanticity_CVPR_2025_paper.pdf) |  [Code](https://github.com/YuWLong666/CoE)|
| CVPR 2025 | [Discovering Fine-Grained Visual-Concept Relations by Disentangled Optimal Transport Concept Bottleneck Models](https://openaccess.thecvf.com/content/CVPR2025/papers/Xie_Discovering_Fine-Grained_Visual-Concept_Relations_by_Disentangled_Optimal_Transport_Concept_Bottleneck_CVPR_2025_paper.pdf) |-|
| CVPR 2025 | [Precise Fast and Low-cost Concept Erasure in_Value_Space](https://openaccess.thecvf.com/content/CVPR2025/papers/Wang_Precise_Fast_and_Low-cost_Concept_Erasure_in_Value_Space__CVPR_2025_paper.pdf) |  [Code](https://github.com/WYuan1001/AdaVD)|
| CVPR 2025 | [Efficient Fine-Tuning and Concept Suppression for Pruned Diffusion Models](https://openaccess.thecvf.com/content/CVPR2025/papers/Shirkavand_Efficient_Fine-Tuning_and_Concept_Suppression_for_Pruned_Diffusion_Models_CVPR_2025_paper.pdf) |  [Code](https://github.com/rezashkv/unlearn-ft)|
| CVPR 2025 | [Self-Evolving Visual Concept Library using Vision-Language Critics](https://openaccess.thecvf.com/content/CVPR2025/papers/Sehgal_Self-Evolving_Visual_Concept_Library_using_Vision-Language_Critics_CVPR_2025_paper.pdf) |  [Code](https://trishullab.github.io/escher-web/)|
| CVPR 2025 | [Concept Lancet: Image Editing with Compositional Representation Transplant](https://openaccess.thecvf.com/content/CVPR2025/papers/Luo_Concept_Lancet_Image_Editing_with_Compositional_Representation_Transplant_CVPR_2025_paper.pdf) |-|
| CVPR 2025 | [Hybrid Concept Bottleneck Models](https://openaccess.thecvf.com/content/CVPR2025/papers/Liu_Hybrid_Concept_Bottleneck_Models_CVPR_2025_paper.pdf) |  [Code](https://github.com/ly1998117/HybridCBM)|
| CVPR 2025 | [Localized Concept Erasure for Text-to-Image Diffusion Models Using Training-Free Gated Low-Rank Adaptation](https://openaccess.thecvf.com/content/CVPR2025/papers/Lee_Localized_Concept_Erasure_for_Text-to-Image_Diffusion_Models_Using_Training-Free_Gated_CVPR_2025_paper.pdf) |  [Code](https://github.com/Hyun1A/GLoCE)|
| CVPR 2025 | [ESC: Erasing Space Concept for Knowledge Deletion](https://openaccess.thecvf.com/content/CVPR2025/papers/Lee_ESC_Erasing_Space_Concept_for_Knowledge_Deletion_CVPR_2025_paper.pdf) |  [Code](https://github.com/KU-VGI/ESC)|
| CVPR 2025 | [Interpretable Generative Models through Post-hoc Concept Bottlenecks](https://openaccess.thecvf.com/content/CVPR2025/papers/Kulkarni_Interpretable_Generative_Models_through_Post-hoc_Concept_Bottlenecks_CVPR_2025_paper.pdf) |  [Code](https://github.com/Trustworthy-ML-Lab/posthoc-generative-cbm)|
| CVPR 2025 | [Discovering Hidden Visual Concepts Beyond Linguistic Input in Infant Learning](https://openaccess.thecvf.com/content/CVPR2025/papers/Ke_Discovering_Hidden_Visual_Concepts_Beyond_Linguistic_Input_in_Infant_Learning_CVPR_2025_paper.pdf) |  [Code](https://github.com/Kexueyi/discover-hidden-visual-concepts)|
| CVPR 2025 | [MC^2: Multi-concept Guidance for Customized Multi-concept Generation](https://openaccess.thecvf.com/content/CVPR2025/papers/Jiang_MC2_Multi-concept_Guidance_for_Customized__Multi-concept_Generation_CVPR_2025_paper.pdf) |  [Code](https://github.com/JIANGJiaXiu/MC-2)|
| CVPR 2025 | [Interactive Medical Image Analysis with Concept-based Similarity Reasoning](https://openaccess.thecvf.com/content/CVPR2025/papers/Huy_Interactive_Medical_Image_Analysis_with_Concept-based_Similarity_Reasoning_CVPR_2025_paper.pdf) |  [Code](https://github.com/tadeephuy/InteractCSR)|
...
| 2024 | [Explain Via Any Concept: Concept Bottleneck Model with Open Vocabulary Concepts](https://doi.org/10.1007/978-3-031-73016-0_8) |-|
| 2024 | [Self-eXplainable AI for Medical Image Analysis: A Survey and New Outlooks](https://arxiv.org/abs/2410.02331) |-|
...
| 2023 | [Robust and interpretable medical image classifiers via concept bottleneck models](https://doi.org/10.48550/arxiv.2310.03182) |-|
